...
<div class="category-page">
  <div class="page-header">
    ...
    <h1>Opinion</h1>
    <p>Takes, arguments, and perspectives on sports — what I think and why.</p>
  </div>

  <nav class="nav-pills">
    <a href="/articles/">All</a>
    <a href="/opinion/" class="active">Opinion</a>
  ...
  <ul class="posts-list">
    ...
    {% if opinion_posts.size > 0 %}
      ...
      {% endfor %}
    {% else %}
      <li><p class="empty-state">No opinion articles yet. Check back soon.</p></li>
    {% endif %}
  </ul>
</div>
